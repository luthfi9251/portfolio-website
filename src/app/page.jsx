...
export default function Home() {
  ...
  return (
    <main className="bg-c-dark-background scroll-smooth overflow-x-hidden">
      <Navbar />
      <HeroSection>{dataText.hero.text.indo}</HeroSection>
      <SkillSection />
      <div className="mt-14 md:py-4 px-6 flex justify-around items-center gap-8 md:gap-2 flex-col md:flex-row">
        <motion.div
        ...
        >
          ...
          <div className="flex text-white justify-between mt-3">
            <div>
              <h2 className="text-4xl text-c-light-green">10</h2>
      ...
      <Project />
      <div className="w-full py-3 md:py-10 flex justify-around items-center flex-wrap">
        <motion.div
      ...
      >
        ...
        >
          ...
          <p className="text-xs lg:text-sm">{dataText.contactMe.text.indo}</p>
          <div className="flex flex-col mt-6">
            <h1 className="font-semibold text-lg block">My Social</h1>
            <div className="flex flex-col gap-3">
              {dataItem.contact.map((item, index) => {
                return (
                  ...
                  >
                    <Image src={item.img} className="w-14 p-2" />
                    <p className="text-xs lg:text-sm">{item.username}</p>
                  </a>
                );
              })}
            </div>
